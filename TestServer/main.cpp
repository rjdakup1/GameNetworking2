...
public:    
    Client(TCPsocket s = NULL, std::string n = "",
           int x1 = 0, int y1= 0, bool a = false)
 ...
 * Global Variables.
 *****************************************************************************/
std::vector<Client> clients; // Create vector of clients
int num_clients = 0;
TCPsocket server;
...
// Converts a float to string ... WE ARE NOT USING FLOATS
/*
